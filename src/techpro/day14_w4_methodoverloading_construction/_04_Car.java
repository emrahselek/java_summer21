package techpro.day14_w4_methodoverloading_construction;
...
public class _04_Car {
	...
	public static void main(String[] args) {
		...
		//ClassName   ObjectName = new Constructor
		    _04_Car car01    = new _04_Car("Audi", 20000, 2017, "Q5", "Black");
		    ...
		    _04_Car car02    = new _04_Car("Honda", 15000, 2019, "CRV", "Red");
	...
	public _04_Car(String make, int price, int year, String model, String color) {
		this.make = make;		
		this.price = price;		
		this.year = year;		
		this.model = model;		
	...
	public _04_Car(String make, int price, int year, String model){
	...
	public _04_Car(int price, int year){
