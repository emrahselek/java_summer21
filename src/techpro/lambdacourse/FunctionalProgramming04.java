...
public class FunctionalProgramming04 {
	...
	public static void main(String[] args) {
        ...
        System.out.println();
        getSumOfIntFrom7To100A(l);
        System.out.println();
        getSumOfIntFrom7To100B(l);
        System.out.println();
        getMultiplicationOfIntFrom2To11(l);
        System.out.println();
        findFactorial(5);
        System.out.println();
        sumOfEvenInGivenRange(4, 13); 
        System.out.println();
        getSumOfDigitsOfInteger(23,25); //23->5, 24->6, 25->7
        System.out.println();
	...
	public static void getSumOfIntFrom7To100A(List<Integer> l) {
	...
	public static void getSumOfIntFrom7To100B(List<Integer> l) {
		Integer sum = IntStream.rangeClosed(7, 100).sum();
		System.out.println(sum);
		// This is a terminal operation --> means you cannot use method after sum()
	...
	public static void getMultiplicationOfIntFrom2To11(List<Integer> l) {
	...
	public static void findFactorial(int x) { //--> x comes from user, code is dynamic
		...
		if(x<0) {
			...
			System.out.println(result); // if it is outside there is scope issue
		}
	} 
	...
	public static void getSumOfDigitsOfInteger(int s, int e) {
		IntStream.rangeClosed(s, e).map(Utils::getSumOfDigits).forEach(Utils::printInTheSameLineWithASpace);
	}
