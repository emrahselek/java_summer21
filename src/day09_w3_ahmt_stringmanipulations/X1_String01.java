package day09_w3_ahmt_stringmanipulations;

import java.util.Scanner;

public class X1_String01 {

	public static void main(String[] args) {
		
		//15.Method: substring() <== Used to get a specific part of a String + Returns String
		String s1 = "Java is easy";// last index no. 11
...
//		System.out.println(ConvertedSsn);//*****6789
		...
		System.out.println(s6.isBlank());//false
		...
		//Example for 1:
		String s9 = "A1b234C7";
		System.out.println(s9.replaceAll("\\d", "*"));//A*b***C*
