package techprClass.day21_w6_slym_Listsforeachloop;
...
public class X1_Lists01 {
	...
	public static void main(String[] args) {
		...
		/*
		 	When you run the following code you will get "UnsupportedOperationException" because
		 	the list is created from an array, and the list has some array features. The significant array feature is to fix in
		 	length. 
