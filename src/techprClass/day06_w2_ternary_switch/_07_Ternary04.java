package techprClass.day06_w2_ternary_switch;

import java.util.Scanner;

public class _07_Ternary04 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		int b = Math.abs(a);//absolute value=mutlak deger - degeri pozitif olarak belirtmek icin kullandik
