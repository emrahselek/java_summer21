...
import java.util.Arrays;public class X4_Arrays04 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//s4.split(" "); for split
		String words[] = s4.split(" ");// " " means, cutting location is space. (Ali/Can/went/to/school)
		System.out.println(Arrays.toString(words));//[Ali, Can, went, to, school]
		
		String parts[] = s4.split("o");// "o" means, cutting all 'o' character.
		System.out.println(Arrays.toString(parts));//[Ali Can went t,  sch, ,l]
		
		String chars[] = s4.split("");// means cutting after any characters. 
