package techprClass.day08_w3_stringmanipulations;
...
public class _01_String01 {
    public static void main(String[] args) {
        ...
        System.out.println(str1.indexOf('a' , 2)); //3,   2 means the index to start the search from 2
        ...
        //10 - startsWith()    --true if the character sequence represented
